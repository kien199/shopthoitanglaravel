...
<html lang="en">
	<head>
		...
		<!-- ace styles -->
		<link rel="stylesheet" href="{{asset('public/backend/css/ace.min.css')}}" class="ace-main-stylesheet" id="main-ace-style" />

		<!--[if lte IE 9]>
			<link rel="stylesheet" href="assets/css/ace-part2.min.css" class="ace-main-stylesheet" />
		<![endif]-->
		<link rel="stylesheet" href="{{asset('public/backend/css/ace-skins.min.css')}}" />
...
<![endif]-->
		...
		<![endif]-->
		<script src="{{asset('public/backend/js/jquery-ui.custom.min.js')}}"></script>
		<script src="{{asset('public/backend/js/jquery.ui.touch-punch.min.js')}}"></script>
		<script src="{{asset('public/backend/js/jquery.easypiechart.min.js')}}"></script>
		<script src="{{asset('public/backend/js/jquery.sparkline.index.min.js')}}"></script>
		...
		<!-- ace scripts -->
		<script src="{{asset('public/backend/js/ace-elements.min.js')}}"></script>
		<script src="{{asset('public/backend/js/ace.min.js')}}"></script>
